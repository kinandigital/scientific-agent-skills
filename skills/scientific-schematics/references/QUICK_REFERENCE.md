...
```bash
# Show help
uv run python scripts/generate_schematic.py --help
...
- [ ] Run `uv run python test_ai_generation.py` (should pass 6/6)
- [ ] Try: `uv run python scripts/generate_schematic.py "test diagram" -o test.png`
