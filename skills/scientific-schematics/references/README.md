...
uv run python scripts/generate_schematic.py "CONSORT participant flow diagram" -o figures/consort.png

# Neural network architecture
uv run python scripts/generate_schematic.py "Transformer encoder-decoder architecture" -o figures/transformer.png

# Biological pathway
uv run python scripts/generate_schematic.py "MAPK signaling pathway" -o figures/pathway.png
```
...
```bash
uv run python scripts/generate_schematic.py [OPTIONS] "description" -o output.png
...
```bash
uv run python test_ai_generation.py
```
