...
Examples:
  ...
  uv run python generate_image.py "A beautiful sunset over mountains"

  # Use a specific model
  uv run python generate_image.py "A cat in space" --model "black-forest-labs/flux.2-pro"

  # Specify output path
  uv run python generate_image.py "Abstract art" --output my_image.png

  # Edit an existing image
  uv run python generate_image.py "Make the sky purple" --input photo.jpg --output edited.png

  # Edit with a specific model
  uv run python generate_image.py "Add a hat to the person" --input portrait.png -m "black-forest-labs/flux.2-pro"
