...
Examples
--------
uv run python validate_samplesheet.py --samplesheet samplesheet.csv
uv run python validate_samplesheet.py --samplesheet samplesheet.csv \
    --metadata metadata.csv --condition-col condition
uv run python validate_samplesheet.py --samplesheet sheet.csv --no-check-files  # skip local file existence
