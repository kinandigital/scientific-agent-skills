...
Usage:
    uv run python calculate_scores.py --scores <dimension_scores.json> --output <report.txt>
    uv run python calculate_scores.py --scores <dimension_scores.json> --weights <weights.json>
    uv run python calculate_scores.py --interactive
...
Examples:
  ...
  uv run python calculate_scores.py --scores my_scores.json

  # Calculate with custom weights
  uv run python calculate_scores.py --scores my_scores.json --weights custom_weights.json

  # Save report to file
  uv run python calculate_scores.py --scores my_scores.json --output report.txt
