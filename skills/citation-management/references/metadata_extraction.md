...
```bash
# Single DOI
uv run python scripts/extract_metadata.py --doi 10.1038/s41586-021-03819-2
...
```bash
# Single PMID
uv run python scripts/extract_metadata.py --pmid 34265844
...
```bash
uv run python scripts/extract_metadata.py --arxiv 2103.14030
```
...
```bash
uv run python scripts/validate_citations.py extracted_refs.bib
```
