...
Examples:
  # Create simple entry
  uv run python entry_operations.py create --nbid 12345 --title "Experiment Results"

  # Create entry with content
  uv run python entry_operations.py create --nbid 12345 --title "Results" \\
  ...
  uv run python entry_operations.py upload --nbid 12345 --entry-id 67890 \\
    --file data.csv

  # Batch upload multiple files
  uv run python entry_operations.py batch-upload --nbid 12345 --entry-id 67890 \\
    --directory ./experiment_data/

  # Add comment to entry
  uv run python entry_operations.py comment --nbid 12345 --entry-id 67890 \\
