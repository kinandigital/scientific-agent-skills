...
Examples:
  # List all notebooks
  uv run python notebook_operations.py list

  # Backup specific notebook
  uv run python notebook_operations.py backup --nbid 12345

  # Backup all notebooks (JSON format, no attachments)
  uv run python notebook_operations.py backup-all --json --no-attachments

  # Backup to custom directory
  uv run python notebook_operations.py backup --nbid 12345 --output my_backups/
        """
    )
