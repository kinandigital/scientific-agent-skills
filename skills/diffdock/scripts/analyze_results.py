...
Usage:
    uv run python analyze_results.py results/output_dir/
    uv run python analyze_results.py results/ --top 50 --threshold 0.0
    uv run python analyze_results.py results/ --export summary.csv
"""
...
Examples:
  ...
  uv run python analyze_results.py results/ --top 5

  # Filter by confidence threshold
  uv run python analyze_results.py results/ --threshold 0.0

  # Export to CSV
  uv run python analyze_results.py results/ --export summary.csv

  # Show top 20 predictions across all complexes
  uv run python analyze_results.py results/ --best 20
        """
    )
