...
Usage:
    ...
    uv run python generate_market_visuals.py --topic "Electric Vehicle Charging" --output-dir figures/
    
    # Generate all 28 visuals (for comprehensive coverage)
    uv run python generate_market_visuals.py --topic "AI in Healthcare" --output-dir figures/ --all
    
    # Skip existing files
    uv run python generate_market_visuals.py --topic "Topic" --output-dir figures/ --skip-existing
"""
