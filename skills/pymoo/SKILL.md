...
**Run examples:**
```bash
uv run python scripts/single_objective_example.py
uv run python scripts/multi_objective_example.py
uv run python scripts/many_objective_example.py
uv run python scripts/custom_problem_example.py
uv run python scripts/decision_making_example.py
```
