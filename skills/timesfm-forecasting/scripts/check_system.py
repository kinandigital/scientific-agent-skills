...
Usage:
    ...
    uv run python check_system.py --model v2.5   # default
    uv run python check_system.py --model v2.0   # archived 500M model
    uv run python check_system.py --model v1.0   # archived 200M model
    uv run python check_system.py --json         # machine-readable output
"""
