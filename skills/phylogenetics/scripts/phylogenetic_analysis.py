...
Usage:
    uv run python phylogenetic_analysis.py sequences.fasta --type nt --threads 4
    uv run python phylogenetic_analysis.py proteins.fasta --type aa --fasttree
"""
...
def visualize_tree(tree_file: str, output_png: str, outgroup: str = None) -> None:
    ...
    try:
        ...
        print("  Install: uv pip install ete3")
        return
