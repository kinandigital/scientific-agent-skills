...
license: MIT
compatibility: Requires the BGPT MCP server configured in the agent host (bunx mcp-remote or bunx bgpt-mcp), internet access to bgpt.pro, and an optional BGPT API key for paid usage.
metadata: {"version": "1.1", "skill-author": "BGPT", "website": "https://bgpt.pro/mcp", "github": "https://github.com/connerlambden/bgpt-mcp"}
---

> **Prerequisites:** This skill requires [bun](https://bun.sh). See the [README](../../README.md#-prerequisites) for installation instructions.
