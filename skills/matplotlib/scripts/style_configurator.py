...
Usage:
    uv run python style_configurator.py [--preset PRESET] [--output FILE] [--preview]
...
Examples:
  ...
  uv run python style_configurator.py --list

  # Preview a preset
  uv run python style_configurator.py --preset publication --preview

  # Save a preset as .mplstyle file
  uv run python style_configurator.py --preset publication --output my_style.mplstyle

  # Interactive mode
  uv run python style_configurator.py --interactive
        """
    )
