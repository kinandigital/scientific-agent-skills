...
Usage:
    ...
    uv run python slides_to_pdf.py slides/*.png -o presentation.pdf
    
    # Combine specific files in order
    uv run python slides_to_pdf.py slide_01.png slide_02.png slide_03.png -o presentation.pdf
    
    # From a directory (sorted by filename)
    uv run python slides_to_pdf.py slides/ -o presentation.pdf
"""
...
Examples:
  ...
  # Combine specific files in order
  uv run python slides_to_pdf.py title.png intro.png methods.png results.png -o talk.pdf
  
  # Combine all images from a directory (sorted by filename)
  uv run python slides_to_pdf.py slides/ -o presentation.pdf
  
  # With custom DPI and verbose output
  uv run python slides_to_pdf.py slides/*.png -o presentation.pdf --dpi 200 -v
...
Tips:
  ...
  - Standard presentation aspect ratio is 16:9 (1920x1080 or 1280x720)
    ...
    if not image_files:
        ...
        print("\nUsage examples:")
        print("  uv run python slides_to_pdf.py slides/*.png -o presentation.pdf")
        print("  uv run python slides_to_pdf.py slide1.png slide2.png -o presentation.pdf")
        sys.exit(1)
