...
Usage:
    uv run python pathway_analysis.py ORGANISM OUTPUT_DIR [--limit N]

Examples:
    uv run python pathway_analysis.py hsa ./human_pathways
    uv run python pathway_analysis.py mmu ./mouse_pathways --limit 50
