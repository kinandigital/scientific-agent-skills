...
Usage:
    uv run python compound_cross_reference.py COMPOUND_NAME [--output FILE]

Examples:
    uv run python compound_cross_reference.py Geldanamycin
    uv run python compound_cross_reference.py "Adenosine triphosphate"
    uv run python compound_cross_reference.py Aspirin --output aspirin_info.txt
"""
