...
Usage:
    ...
    uv run python protein_analysis_workflow.py PROTEIN_NAME [EMAIL] [--skip-blast]

Examples:
    uv run python protein_analysis_workflow.py ZAP70_HUMAN
    uv run python protein_analysis_workflow.py P43403 user@example.com --skip-blast
