...
Examples:
  # Validate BAM files
  uv run python validate_files.py --bam sample1.bam sample2.bam

  # Validate all file types
  uv run python validate_files.py --bam input.bam chip.bam --bed peaks.bed --bigwig signal.bw

  # Validate from a directory
  uv run python validate_files.py --bam *.bam --bed *.bed
        """
    )
