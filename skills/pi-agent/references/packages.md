...
Git specs support HTTPS, SSH, and shorthand with `git:`. Refs are pinned tags or commits. Reconciliation may reset/clean clones and run `bun install` when `package.json` exists.
