...
Usage:
    uv run python molecular_properties.py "CCO"
    uv run python molecular_properties.py --file molecules.smi --output properties.csv
"""
...
Examples:
  ...
  # From file
  uv run python molecular_properties.py --file molecules.smi

  # Save to CSV
  uv run python molecular_properties.py --file molecules.sdf --output properties.csv
        """
    )
