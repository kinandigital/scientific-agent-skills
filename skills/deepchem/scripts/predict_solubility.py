...
Usage:
    uv run python predict_solubility.py --data custom_data.csv --smiles-col smiles --target-col solubility
    uv run python predict_solubility.py  # Uses Delaney dataset by default
"""
