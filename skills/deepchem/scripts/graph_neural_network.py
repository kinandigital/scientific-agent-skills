...
Usage:
    uv run python graph_neural_network.py --dataset tox21 --model gcn
    uv run python graph_neural_network.py --dataset bbbp --model attentivefp
    uv run python graph_neural_network.py --data custom.csv --task-type regression
"""
