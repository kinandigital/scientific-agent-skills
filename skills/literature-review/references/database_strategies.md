...
# uv run python search_databases.py combined_results.json --deduplicate --format markdown --output review_papers.md

# 6. Verify all citations
# uv run python verify_citations.py review_papers.md

# 7. Generate final PDF
# uv run python generate_pdf.py review_papers.md --citation-style nature
```
