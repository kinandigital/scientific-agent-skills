...
Usage:
    uv run python theoretical_spectrum.py DFPIANGER
    uv run python theoretical_spectrum.py PEPTIDEK --charge 2 --ions b y a --losses
    uv run python theoretical_spectrum.py DFPIANGER --out-mzml theo.mzML --out-csv peaks.csv
"""
