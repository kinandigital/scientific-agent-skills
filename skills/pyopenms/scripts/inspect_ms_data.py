...
Usage:
    uv run python inspect_ms_data.py data.mzML
    uv run python inspect_ms_data.py data.mzML --spectra-csv spectra.csv
    uv run python inspect_ms_data.py features.featureXML
    uv run python inspect_ms_data.py ids.idXML
"""
