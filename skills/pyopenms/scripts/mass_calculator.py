...
Usage:
    uv run python mass_calculator.py --peptide DFPIANGER
    uv run python mass_calculator.py --peptide "PEPTIDEM(Oxidation)K" --charges 1 2 3
    uv run python mass_calculator.py --formula C6H12O6 --isotopes 5
    uv run python mass_calculator.py --peptide DFPIANGER --isotopes 6 --csv iso.csv
"""
