...
Usage:
    uv run python convert_format.py input.mzXML output.mzML
    uv run python convert_format.py input.mzML peaks.mgf --ms-level 2
    uv run python convert_format.py input.mzML out.mzML --rt-min 60 --rt-max 600 --min-intensity 500
"""
