...
Usage:
    uv run python detect_features_centroided.py centroided.mzML
    uv run python detect_features_centroided.py data.mzML --out-csv feats.csv --charge-low 2 --charge-high 5
"""
