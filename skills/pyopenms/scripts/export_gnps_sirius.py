...
Usage:
    uv run python export_gnps_sirius.py gnps study.consensusXML --mzml s1.mzML s2.mzML --out-prefix gnps_out
    uv run python export_gnps_sirius.py sirius sample.mzML --featurexml sample.featureXML --out sample.ms
"""
