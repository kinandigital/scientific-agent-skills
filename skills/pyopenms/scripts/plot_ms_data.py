...
Usage:
    uv run python plot_ms_data.py spectrum data.mzML --index 0 --out spec.png
    uv run python plot_ms_data.py tic data.mzML --out tic.png
    uv run python plot_ms_data.py featuremap features.featureXML --out fmap.png
    uv run python plot_ms_data.py map2d data.mzML --out map.png
"""
