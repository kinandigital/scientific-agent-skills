...
Usage:
    uv run python process_spectra.py raw.mzML centroided.mzML --smooth gauss --pick
    uv run python process_spectra.py data.mzML out.mzML --normalize to_one --threshold 100
    uv run python process_spectra.py data.mzML out.mzML --ms-level 1 --sn 2.0
"""
