...
Usage:
    uv run python consensus_to_matrix.py study.consensusXML --out quant.csv
    uv run python consensus_to_matrix.py study.consensusXML --out quant.csv --normalize median
    uv run python consensus_to_matrix.py study.consensusXML --out quant.csv --long long.csv
"""
