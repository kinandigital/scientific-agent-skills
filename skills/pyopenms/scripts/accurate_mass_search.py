...
Usage:
    uv run python accurate_mass_search.py features.featureXML --out-mztab hits.mzTab
    uv run python accurate_mass_search.py features.featureXML --negative --ppm 5 --csv hits.csv
"""
