...
Usage:
    uv run python digest_protein.py proteins.fasta --out peptides.csv
    uv run python digest_protein.py --sequence MKWVTFISLLLLFSSAYS --enzyme Trypsin --missed 2
    uv run python digest_protein.py proteins.fasta --min-length 7 --max-length 40 --charges 1 2 3
"""
