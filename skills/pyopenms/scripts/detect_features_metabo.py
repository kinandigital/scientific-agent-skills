...
Usage:
    uv run python detect_features_metabo.py sample.mzML
    uv run python detect_features_metabo.py sample.mzML --out-features feats.featureXML --out-csv feats.csv
    uv run python detect_features_metabo.py sample.mzML --ppm 5 --noise 5000 --charge-low 1 --charge-high 3
"""
