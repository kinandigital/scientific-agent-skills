...
Usage:
    uv run python align_link_quantify.py s1.mzML s2.mzML s3.mzML --out-prefix study
    uv run python align_link_quantify.py *.featureXML --out-prefix study --rt-tol 20 --mz-tol 10
"""
