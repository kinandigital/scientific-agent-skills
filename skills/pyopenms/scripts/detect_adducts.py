...
Usage:
    uv run python detect_adducts.py features.featureXML --out-features decharged.featureXML
    uv run python detect_adducts.py features.featureXML --negative
    uv run python detect_adducts.py features.featureXML --adducts "H:+:0.6,Na:+:0.2,K:+:0.2"
"""
