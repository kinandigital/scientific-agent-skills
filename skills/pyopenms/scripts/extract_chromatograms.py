...
Usage:
    uv run python extract_chromatograms.py data.mzML --tic --bpc --out chrom.csv
    uv run python extract_chromatograms.py data.mzML --mz 300.15 450.22 --ppm 10 --out xic.csv --plot xic.png
"""
