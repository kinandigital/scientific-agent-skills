...
> **Prerequisites:** This skill requires [uv](https://docs.astral.sh/uv/) and [bun](https://bun.sh). See the [README](../../README.md#-prerequisites) for installation instructions.
...
The older Node.js-based validator (`bun add -g bids-validator`) is deprecated in favor of the Deno-based version. The Deno version is the reference implementation for BIDS Specification v1.9+.
...
Update schema and BEPs with: `uv run python scripts/update_schema.py`
