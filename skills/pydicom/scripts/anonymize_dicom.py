...
Usage:
    uv run python anonymize_dicom.py input.dcm output.dcm
    uv run python anonymize_dicom.py input.dcm output.dcm --patient-id ANON001
"""
...
Examples:
  uv run python anonymize_dicom.py input.dcm output.dcm
  uv run python anonymize_dicom.py input.dcm output.dcm --patient-id ANON001
  uv run python anonymize_dicom.py input.dcm output.dcm --patient-id ANON001 --patient-name "Anonymous^Patient"
        """
    )
