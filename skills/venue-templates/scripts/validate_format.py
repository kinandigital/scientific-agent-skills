...
Usage:
    uv run python validate_format.py --file my_paper.pdf --venue "Nature" --check-all
    uv run python validate_format.py --file my_paper.pdf --venue "NeurIPS" --check page-count,margins
    uv run python validate_format.py --file my_paper.pdf --venue "PLOS ONE" --report validation_report.txt
"""
