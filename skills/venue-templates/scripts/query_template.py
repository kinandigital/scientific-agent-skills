...
Usage:
    uv run python query_template.py --venue "Nature" --type "article"
    uv run python query_template.py --keyword "machine learning"
    uv run python query_template.py --list-all
    uv run python query_template.py --venue "NeurIPS" --requirements
"""
