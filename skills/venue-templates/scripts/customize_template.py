...
Usage:
    uv run python customize_template.py --template nature_article.tex --output my_paper.tex
    uv run python customize_template.py --template nature_article.tex --title "My Research" --output my_paper.tex
    uv run python customize_template.py --interactive
"""
