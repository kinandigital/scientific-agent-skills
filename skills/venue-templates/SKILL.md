...
```bash
uv run python scripts/customize_template.py \
  --template assets/journals/nature_article.tex \
...
uv run python scripts/query_template.py --venue "Nature" --type "article"

# Search by keyword
uv run python scripts/query_template.py --keyword "machine learning"

# List all available templates
uv run python scripts/query_template.py --list-all

# Get requirements for a venue
uv run python scripts/query_template.py --venue "NeurIPS" --requirements
```
...
# Interactive mode
uv run python scripts/customize_template.py --interactive
```
