...
Examples:
    uv run python score_genes.py annotated.h5ad -o scored.h5ad --gene-sets signatures.json
    uv run python score_genes.py annotated.h5ad -o scored.h5ad --cell-cycle
"""
