...
Examples:
    uv run python subset.py annotated.h5ad -o tcells.h5ad --obs cell_type --keep "CD4 T cells" "CD8 T cells"
    uv run python subset.py annotated.h5ad -o no_doublets.h5ad --obs predicted_doublet --drop True
    uv run python subset.py data.h5ad -o panel.h5ad --genes CD3D CD14 MS4A1 NKG7
"""
