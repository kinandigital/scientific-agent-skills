...
Examples:
    uv run python cluster.py reduced.h5ad -o clustered.h5ad --resolution 0.5
    uv run python cluster.py reduced.h5ad -o clustered.h5ad --resolution 0.3 0.5 0.8 1.0
    uv run python cluster.py reduced.h5ad -o clustered.h5ad --algorithm louvain
"""
