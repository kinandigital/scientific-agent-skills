...
Examples:
    uv run python qc_analysis.py raw.h5ad -o filtered.h5ad
    uv run python qc_analysis.py raw.h5ad -o filtered.h5ad --mt-threshold 10 --min-genes 500
    uv run python qc_analysis.py 10x_dir/ -o filtered.h5ad --max-genes 6000 --scrublet
"""
