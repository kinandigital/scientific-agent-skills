...
Examples:
    uv run python pseudobulk.py annotated.h5ad --by sample cell_type --out-prefix results/pb
    uv run python pseudobulk.py annotated.h5ad --by sample cell_type --layer counts --out-prefix pb
"""
