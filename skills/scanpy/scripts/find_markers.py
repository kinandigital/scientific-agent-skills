...
Examples:
    uv run python find_markers.py clustered.h5ad -o markers.h5ad
    uv run python find_markers.py clustered.h5ad --groupby leiden --method wilcoxon --n-genes 50
    uv run python find_markers.py clustered.h5ad --csv-dir results/markers --top 10
"""
