...
Examples:
    uv run python annotate.py clustered.h5ad -o annotated.h5ad --mapping celltypes.json
    uv run python annotate.py clustered.h5ad -o annotated.h5ad --mapping map.csv --cluster-key leiden
    uv run python annotate.py clustered.h5ad --markers markers.json --cluster-key leiden   # dotplot only
"""
