...
Examples:
    uv run python preprocess.py filtered.h5ad -o normalized.h5ad
    uv run python preprocess.py filtered.h5ad -o normalized.h5ad --n-top-genes 3000 --scale
    uv run python preprocess.py filtered.h5ad -o normalized.h5ad --flavor seurat_v3 --batch-key sample
    uv run python preprocess.py filtered.h5ad -o normalized.h5ad --regress-out total_counts pct_counts_mt
"""
