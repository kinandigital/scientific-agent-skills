...
Examples:
    uv run python plot.py annotated.h5ad --kind umap --color leiden cell_type
    uv run python plot.py annotated.h5ad --kind umap --genes CD3D MS4A1 NKG7 --use-raw
    uv run python plot.py annotated.h5ad --kind dotplot --genes CD3D CD14 MS4A1 --groupby cell_type
    uv run python plot.py annotated.h5ad --kind violin --genes CD3D --groupby leiden
"""
