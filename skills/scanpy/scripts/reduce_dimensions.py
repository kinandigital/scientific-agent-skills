...
Examples:
    uv run python reduce_dimensions.py normalized.h5ad -o reduced.h5ad
    uv run python reduce_dimensions.py normalized.h5ad -o reduced.h5ad --n-pcs 50 --n-neighbors 15
    uv run python reduce_dimensions.py normalized.h5ad -o reduced.h5ad --tsne --use-rep X_pca_harmony
"""
