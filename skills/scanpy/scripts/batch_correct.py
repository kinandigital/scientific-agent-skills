...
Examples:
    uv run python batch_correct.py reduced.h5ad -o integrated.h5ad --method harmony --batch-key sample
    uv run python batch_correct.py reduced.h5ad -o integrated.h5ad --method bbknn --batch-key sample
    uv run python batch_correct.py normalized.h5ad -o integrated.h5ad --method combat --batch-key batch
"""
