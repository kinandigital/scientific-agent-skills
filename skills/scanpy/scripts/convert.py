...
Examples:
    uv run python convert.py filtered_feature_bc_matrix/ -o data.h5ad
    uv run python convert.py raw_counts.csv -o data.h5ad --transpose
    uv run python convert.py matrix.h5 -o data.h5ad
"""
