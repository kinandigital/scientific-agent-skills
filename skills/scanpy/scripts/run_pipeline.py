...
Examples:
    uv run python run_pipeline.py raw.h5ad -o processed.h5ad
    uv run python run_pipeline.py raw.h5ad -o processed.h5ad --resolution 0.8 --n-top-genes 3000
    uv run python run_pipeline.py raw.h5ad -o processed.h5ad --batch-key sample --batch-method harmony
    uv run python run_pipeline.py raw.h5ad -o processed.h5ad --config params.json
"""
