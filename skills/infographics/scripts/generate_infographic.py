...
Usage:
    uv run python generate_infographic.py "5 benefits of exercise" -o benefits.png --type list
    uv run python generate_infographic.py "Company history 2010-2025" -o timeline.png --type timeline --style corporate
    uv run python generate_infographic.py --list-options
"""
...
Examples:
  uv run python generate_infographic.py "5 benefits of exercise" -o benefits.png --type list
  uv run python generate_infographic.py "AI adoption 2020-2025" -o timeline.png --type timeline --style technology
  uv run python generate_infographic.py "Product comparison" -o compare.png --type comparison --palette wong
...
Examples:
  ...
  uv run python generate_infographic.py "5 benefits of meditation" -o benefits.png --type list
  
  # Corporate timeline
  uv run python generate_infographic.py "Company history 2010-2025" -o timeline.png --type timeline --style corporate
  
  # Healthcare statistics with colorblind-safe colors
  uv run python generate_infographic.py "Heart disease statistics" -o stats.png --type statistical --style healthcare --palette wong
  
  # Statistical infographic WITH RESEARCH for accurate data
  uv run python generate_infographic.py "Global AI market size and growth" -o ai_market.png --type statistical --research
  
  # Social media infographic
  uv run python generate_infographic.py "Save water tips" -o water.png --type social --style marketing
