...
Usage:
    uv run python generate_infographic_ai.py "5 benefits of exercise" -o benefits.png --type list
    uv run python generate_infographic_ai.py "Global AI market size" -o ai_market.png --type statistical --research
    uv run python generate_infographic_ai.py "Company history 2010-2025" -o timeline.png --type timeline --style corporate
"""
...
Examples:
  ...
  uv run python generate_infographic_ai.py "5 benefits of meditation" -o benefits.png --type list
  
  # Generate a timeline with corporate style
  uv run python generate_infographic_ai.py "Company history 2010-2025" -o timeline.png --type timeline --style corporate
  
  # Generate with colorblind-safe palette
  uv run python generate_infographic_ai.py "Heart disease stats" -o stats.png --type statistical --palette wong
  
  # Generate with RESEARCH for accurate data (uses Perplexity Sonar)
  uv run python generate_infographic_ai.py "Global AI market 2025" -o ai_market.png --type statistical --research
  
  # Generate using reference images as visual/content context
  uv run python generate_infographic_ai.py "Create a branded hiring infographic" -o hiring.png --context-image logo.png --context-image brand_chart.png
  
  # Verbose output
  uv run python generate_infographic_ai.py "Process diagram" -o process.png --type process -v
