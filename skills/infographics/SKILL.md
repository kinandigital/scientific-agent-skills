...
uv run python skills/infographics/scripts/generate_infographic.py \
...
```bash
uv run python skills/infographics/scripts/generate_infographic.py [OPTIONS] PROMPT
...
```bash
uv run python skills/infographics/scripts/generate_infographic.py --list-options
```
