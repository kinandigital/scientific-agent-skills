...
Usage:
    uv run python phase_diagram_generator.py chemical_system [options]

Examples:
    uv run python phase_diagram_generator.py Li-Fe-O
    uv run python phase_diagram_generator.py Li-Fe-O --output li_fe_o_pd.png
    uv run python phase_diagram_generator.py Fe-O --show
    uv run python phase_diagram_generator.py Li-Fe-O --analyze "LiFeO2"
"""
