...
Usage:
    uv run python structure_analyzer.py structure_file [options]

Examples:
    uv run python structure_analyzer.py POSCAR
    uv run python structure_analyzer.py structure.cif --symmetry --neighbors
    uv run python structure_analyzer.py POSCAR --export json
"""
