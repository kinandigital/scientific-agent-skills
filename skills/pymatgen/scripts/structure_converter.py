...
Usage:
    uv run python structure_converter.py input_file output_file
    uv run python structure_converter.py input_file --format cif
    uv run python structure_converter.py *.cif --output-dir ./converted --format poscar

Examples:
    uv run python structure_converter.py POSCAR structure.cif
    uv run python structure_converter.py structure.cif --format json
    uv run python structure_converter.py *.vasp --output-dir ./cif_files --format cif
"""
