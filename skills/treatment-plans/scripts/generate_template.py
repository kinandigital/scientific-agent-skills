...
def display_success(output_path, template_key):
    ...
    print("\n3. VALIDATE (optional):")
    print(f"   $ uv run python check_completeness.py {output_path.name}")
    print(f"   $ uv run python validate_treatment_plan.py {output_path.name}")
...
Examples:
  ...
  uv run python generate_template.py --type mental_health

  # List available templates
  uv run python generate_template.py --list
