...
Usage:
    ...
    uv run python generate_schematic.py "CONSORT flowchart" -o flowchart.png --doc-type journal
    
    # Generate for presentation (lower threshold, faster)
    uv run python generate_schematic.py "Transformer architecture" -o transformer.png --doc-type presentation
    
    # Generate for poster
    uv run python generate_schematic.py "MAPK signaling pathway" -o pathway.png --doc-type poster
"""
...
Examples:
  ...
  uv run python generate_schematic.py "CONSORT participant flow" -o flowchart.png --doc-type journal
  
  # Generate for poster (moderate quality)
  uv run python generate_schematic.py "Transformer architecture" -o arch.png --doc-type poster
  
  # Generate for slides (faster, lower threshold)
  uv run python generate_schematic.py "System diagram" -o system.png --doc-type presentation
  
  # Custom max iterations
  uv run python generate_schematic.py "Complex pathway" -o pathway.png --iterations 2
  
  # Verbose output
  uv run python generate_schematic.py "Circuit diagram" -o circuit.png -v
