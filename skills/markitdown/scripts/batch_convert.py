...
Examples:
  ...
  uv run python batch_convert.py papers/ output/ --extensions .pdf
  
  # Convert multiple formats recursively
  uv run python batch_convert.py documents/ markdown/ --extensions .pdf .docx .pptx -r
  
  # Use 8 parallel workers
  uv run python batch_convert.py input/ output/ --workers 8
  
  # Enable plugins
  uv run python batch_convert.py input/ output/ --plugins
        """
    )
