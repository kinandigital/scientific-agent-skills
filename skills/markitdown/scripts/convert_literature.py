...
Examples:
  ...
  uv run python convert_literature.py papers/ output/
  
  # Organize by year
  uv run python convert_literature.py papers/ output/ --organize-by-year
  
  # Create index of all papers
  uv run python convert_literature.py papers/ output/ --create-index
