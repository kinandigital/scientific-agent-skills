...
```bash
uv run python scripts/fetch_catalog.py topic biology
uv run python scripts/fetch_catalog.py topic materials-science --filter models
uv run python scripts/fetch_catalog.py search "protein language model"
uv run python scripts/fetch_catalog.py all     # full llms-full.txt
```
