...
# Example usage:
# uv run python validate_cds_document.py cohort_analysis.tex
# uv run python validate_cds_document.py treatment_recommendations.tex -o validation_report.txt
# uv run python validate_cds_document.py document.tex --strict  # Warnings cause failure
