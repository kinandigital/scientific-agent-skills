...
> **Fork notice:** This repository is maintained by [Kinan Digital](https://github.com/kinandigital). It is a fork of [K-Dense-AI/scientific-agent-skills](https://github.com/K-Dense-AI/scientific-agent-skills), which is referenced as the upstream source.
...
> **Stay up to date:** Follow the upstream project [K-Dense](https://github.com/K-Dense-AI) on [X](https://x.com/k_dense_ai), [LinkedIn](https://www.linkedin.com/company/k-dense-inc), and [YouTube](https://www.youtube.com/@K-Dense-Inc) for new skills, release announcements, walkthroughs, and research workflow demos.

A comprehensive collection of **147 ready-to-use scientific and research skills** (covering cancer genomics, drug-target binding, molecular dynamics, RNA velocity, geospatial science, time series forecasting, scientific ML resource discovery via Hugging Science, 78+ scientific databases, and more) for any AI agent that supports the open [Agent Skills](https://agentskills.io/) standard. Works with **Cursor, Claude Code, Codex, Google Antigravity, and more**. Transform your AI agent into a research assistant capable of executing complex multi-step scientific workflows across biology, chemistry, medicine, and beyond.
...
- **Regular Updates** - Continuously maintained and expanded by the Kinan Digital team
...
### Option 1: bunx (all platforms)

Install Scientific Agent Skills with a single command:

```bash
bunx skills add kinandigital/scientific-agent-skills
```
...
gh skill install kinandigital/scientific-agent-skills

# Install a specific skill directly
gh skill install kinandigital/scientific-agent-skills scanpy

# Target a specific agent host
gh skill install kinandigital/scientific-agent-skills --agent cursor
gh skill install kinandigital/scientific-agent-skills --agent claude-code
gh skill install kinandigital/scientific-agent-skills --agent codex
gh skill install kinandigital/scientific-agent-skills --agent gemini
```
...
gh skill install kinandigital/scientific-agent-skills --pin v1.0.0

# Pin to a commit SHA
gh skill install kinandigital/scientific-agent-skills --pin abc123def
```
...
- **Do not install everything at once.** Only install the skills you actually need for your work. While installing the full collection was reasonable when the upstream project created and maintained every skill, the repository now includes many community contributions that we may not have reviewed as thoroughly.
...
- **Check the contribution history.** Skills authored by the upstream project (`K-Dense-AI`) have been through their internal review process. Community-contributed skills have been reviewed to the best of our ability, but with limited resources.
- **Run the security scanner yourself.** Before installing third-party skills, scan them locally:
  ```bash
  uv pip install cisco-ai-skill-scanner
  skill-scanner scan /path/to/skill --use-behavioral
  ```
- **Report anything suspicious.** If you find a skill that looks malicious or behaves unexpectedly, please [open an issue](https://github.com/kinandigital/scientific-agent-skills/issues) immediately so we can investigate.
...
- **bun**: JavaScript runtime and package manager (required for skills that use Node.js packages)
...
Some skills (e.g., `docx`, `pptx`, `bgpt-paper-search`) use JavaScript packages via `bun`. Install it using the instructions for your operating system:
...
For more installation options and details, visit the [official bun documentation](https://bun.sh/docs/installation).
...
- Kinan Digital community highlights
...
- Re-run `gh skill install kinandigital/scientific-agent-skills` after pulling the latest release
...
- 🐛 **Bug Reports**: [Open an issue](https://github.com/kinandigital/scientific-agent-skills/issues)
- 💡 **Feature Requests**: [Submit a feature request](https://github.com/kinandigital/scientific-agent-skills/issues/new)
- 📣 **Updates and demos**: Follow the upstream project [K-Dense](https://github.com/K-Dense-AI) on [X](https://x.com/k_dense_ai), [LinkedIn](https://www.linkedin.com/company/k-dense-inc), and [YouTube](https://www.youtube.com/@K-Dense-Inc) to keep up with new skills, tutorials, and releases
- 💼 **Enterprise Support**: Contact [Kinan Digital](https://github.com/kinandigital) for commercial support
...
#### APA
```
Kinan Digital (2026). Scientific Agent Skills: A comprehensive collection of scientific tools for AI agents [Computer software]. https://github.com/kinandigital/scientific-agent-skills
```

#### MLA
```
Kinan Digital Scientific Agent Skills: A Comprehensive Collection of Scientific Tools for AI Agents. 2026, github.com/kinandigital/scientific-agent-skills.
```

#### Plain Text
```
Scientific Agent Skills by Kinan Digital (2026)
Available at: https://github.com/kinandigital/scientific-agent-skills
```
...
@software{scientific_agent_skills_astropy_2026,
  ...
  year = {2026},
  url = {https://github.com/kinandigital/scientific-agent-skills/tree/main/skills/astropy},
...
Kinan Digital (2026).
https://github.com/kinandigital/scientific-agent-skills/tree/main/skills/astropy
```
...
**Copyright © 2026 Kinan Digital** ([github.com/kinandigital](https://github.com/kinandigital)). Forked from [K-Dense-AI/scientific-agent-skills](https://github.com/K-Dense-AI/scientific-agent-skills).
